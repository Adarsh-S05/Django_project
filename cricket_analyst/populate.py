...
# Columns:
# name, country, ipl_short, role, bat_style, bowl_style, is_overseas, dob, photo_id
...
PLAYERS = [
    ...
    ("Yuvraj Singh",       "India","PBKS","All-Rounder","Left-hand bat", "Left-arm orthodox",        False,date(1981,12,12),28671, 132,2750,38, 30.1,148.6,7.7, 70, "3/14",  0,13,52,0),
